function [ErrKarray, ErrKCarray, ErrHinfarray, ErrHinfCarray] = AddHinfConstr(g, T, tf, Unmodeled)
...
%   Unmodeled = flag indicating if the system has unmodeled dynamics
% OUTPUTS
...
set(gca,'FontSize',12); set(gcf,'Color','White');
ylabel('meters (unconstrained)');
title('Kalman Position Estimation Error');
...
set(gca,'FontSize',12); set(gcf,'Color','White');
ylabel('meters (unconstrained)');
title('Minimax Position Estimation Error');
...
set(gca,'FontSize',12); set(gcf,'Color','White');
ylabel('m/sec (unconstrained)');
title('Kalman Velocity Estimation Error');
...
set(gca,'FontSize',12); set(gcf,'Color','White');
ylabel('m/sec (unconstrained)');
title('Minimax Velocity Estimation Error');
